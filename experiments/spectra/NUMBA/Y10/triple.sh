...
#SBATCH -J PYTHON_NUMBA_Y10_Triple
...
# Run applications
srun -n 1 -c $SLURM_CPUS_PER_TASK python -u "${PROJECT_ROOT}/experiments/spectra/NUMBA/${TAG}/${LABEL,,}.py" --tag="${TAG}" --label="${LABEL}" --folder="${RUNTIME_ROOT}" --number="${SLURM_CPUS_PER_TASK}"
