...
def main(
    ...
    result_folder = paths.spectrum_results("JAX", tag, "GPU")
    ...
    for index in range(-1, int(count_list.max()) if count_list.size else 0):
        ...
        if activity["MS"]:
            ...
            cell_data_ms = numpy.zeros((lens_bin_size, source_bin_size, ell_size + 1))
        ...
        if activity["MI"]:
            ...
            cell_data_mi = numpy.zeros((lens_bin_size, source_bin_size, ell_size + 1))
        ...
        if activity["GS"]:
            ...
            cell_data_gs = numpy.zeros((lens_bin_size, source_bin_size, ell_size + 1))
        ...
        if activity["GI"]:
            ...
            cell_data_gi = numpy.zeros((lens_bin_size, source_bin_size, ell_size + 1))
        ...
        if activity["MM"]:
            ...
            cell_data_mm = numpy.zeros((lens_bin_size, lens_bin_size, ell_size + 1))
        ...
        if activity["MG"]:
            ...
            cell_data_mg = numpy.zeros((lens_bin_size, lens_bin_size, ell_size + 1))
        ...
        if activity["GM"]:
            ...
            cell_data_gm = numpy.zeros((lens_bin_size, lens_bin_size, ell_size + 1))
        ...
        if activity["GG"]:
            ...
            cell_data_gg = numpy.zeros((lens_bin_size, lens_bin_size, ell_size + 1))
