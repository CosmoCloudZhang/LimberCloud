...
# Run applications
LABEL="Single"
python -u "${REPO_ROOT}/experiments/benchmarks/${TAG}/benchmark.py" --tag="${TAG}" --path="${REPO_ROOT}" --label="${LABEL}" --folder="${RUNTIME_ROOT}" --number="${SLURM_CPUS_PER_TASK}"
