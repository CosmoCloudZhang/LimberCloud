...
def main(tag, folder):
    ...
    # Source
    source = numpy.load(os.path.join(data_folder, f'{tag}/lsst_source_bins.npy'), allow_pickle=True).item()
    ...
    table_source.write(os.path.join(covariance_folder, f'{tag}/SOURCE.ascii'), overwrite = True, format = 'ascii')

    # Lens
    lens = numpy.load(os.path.join(data_folder, f'{tag}/lsst_lens_bins.npy'), allow_pickle=True).item()
    ...
    table_lens.write(os.path.join(covariance_folder, f'{tag}/LENS.ascii'), overwrite = True, format = 'ascii')
    ...
    table_alignment.write(os.path.join(covariance_folder, f'{tag}/ALIGNMENT.ascii'), overwrite = True, format = 'ascii')
    ...
    table_galaxy.write(os.path.join(covariance_folder, f'{tag}/GALAXY.ascii'), overwrite = True, format = 'ascii')
    ...
    for m in range(lens_bin_size):
        table_magnification[f'm_{m + 1}(z)'] = magnification_bias[m] * numpy.ones(grid_size + 1)
    table_magnification.write(os.path.join(covariance_folder, f'{tag}/MAGNIFICATION.ascii'), overwrite = True, format = 'ascii')
    ...
    table_cell.write(os.path.join(covariance_folder, f'{tag}/Cell_kappakappa.ascii'), overwrite = True, format = 'ascii')
    ...
    table_cell.write(os.path.join(covariance_folder, f'{tag}/Cell_gkappa.ascii'), overwrite = True, format = 'ascii')
    ...
    table_cell.write(os.path.join(covariance_folder, f'{tag}/Cell_gg.ascii'), overwrite = True, format = 'ascii')
