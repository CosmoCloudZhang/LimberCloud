...
def main(tag, path, label, folder, number):
    ...
    plot_panel(rows_total, plot[0], count_list, r'$\mathrm{Total}$')
    ...
    plot_panel(rows_cosmology, plot[1], count_list, r'$\mathrm{Cosmology \, stage}$')
    ...
    plot_panel(rows_coefficient, plot[2], count_list, r'$\mathrm{Coefficient \, stage}$')
    ...
    plot_panel(rows_projection, plot[3], count_list, r'$\mathrm{Projection \, stage}$')
