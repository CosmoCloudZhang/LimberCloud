...
| Local checkout | `57c0731cf87562d71a308191deccdba0245cc099`, initially clean `main` | Left on its original commit. All seven scientific section files and core projection files match the newer GitHub snapshot; environment infrastructure and notebook paths differ. The newer main document also changes the author block; this review does not change authorship. |
...
- Locations follow the **current scientific draft**, before the proposed reorganisation. Joe's Figure 8 comment was filed under Section 5 but belongs to current Section 6.1. His scale-dependent-bias comment was filed under Section 4 but primarily targets the current Section 5 preamble.
