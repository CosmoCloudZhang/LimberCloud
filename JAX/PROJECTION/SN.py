...
def element(n, i, j, chi_grid, power_grid, redshift_grid):
    ...
    condition2 = (n + 1 == i) & (n == j) & (n + 1 < grid_size)
    condition3 = (n + 1 < i) & (i < grid_size) & (n == j) & (n + 1 < grid_size)
    condition4 = (n + 1 < i) & (i < grid_size) & (n + 1 == j) & (n + 1 < grid_size)
    condition5 = (n == i) & (n + 1 == j) & (n + 2 < chi_grid.shape[0])
    condition6 = (n + 1 == i) & (n + 1 == j) & (n + 2 < chi_grid.shape[0])
    condition7 = (n == i) & (j == grid_size) & (n < grid_size)
    condition8 = (n + 1 == i) & (j == grid_size) & (n + 1 < grid_size)
    
    branch_index = jnp.select(
        [condition0, condition1, condition2, condition3, condition4, condition5, condition6, condition7, condition8],
        [0, 1, 2, 3, 4, 5, 6, 7, 8],
        default=0
    )
    ...
    def compute_element2(_):
        return element2(chi_grid[n], chi_grid[n + 1], power_grid[:, n], power_grid[:, n + 1], redshift_grid[n], redshift_grid[n + 1])
    ...
    def compute_element4(_):
        return element4(chi_grid[n], chi_grid[n + 1], chi_grid[i - 1], chi_grid[i], chi_grid[i + 1], power_grid[:, n], power_grid[:, n + 1], redshift_grid[n], redshift_grid[n + 1])
    ...
    def compute_element6(_):
        return element6(chi_grid[n], chi_grid[n + 1], chi_grid[n + 2], power_grid[:, n], power_grid[:, n + 1], redshift_grid[n], redshift_grid[n + 1])
    
    def compute_element7(_):
        return element7(chi_grid[n], chi_grid[n + 1], chi_grid[-2], chi_grid[-1], power_grid[:, n], power_grid[:, n + 1], redshift_grid[n], redshift_grid[n + 1])
    
    def compute_element8(_):
        return element8(chi_grid[n], chi_grid[n + 1], chi_grid[-2], chi_grid[-1], power_grid[:, n], power_grid[:, n + 1], redshift_grid[n], redshift_grid[n + 1])
    
    branches = [return_zeros, compute_element1, compute_element2, compute_element3,
                compute_element4, compute_element5, compute_element6, compute_element7, compute_element8]
