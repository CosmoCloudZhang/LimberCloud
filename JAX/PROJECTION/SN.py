...
def coefficient(chi_grid, power_grid, redshift_grid):
    ...
    def accumulate_step(n, coefficients):
        ...
        def compute_element4(k):
            return element4(chi_grid[n], chi_grid[n + 1], chi_grid[k - 1], chi_grid[k], chi_grid[k + 1],power_grid[:, n], power_grid[:, n + 1], redshift_grid[n], redshift_grid[n + 1])
        ...
        coefficients = coefficients.at[n + 1, grid_size, :].add(jnp.where(valid, value8, jnp.zeros_like(value8)))
