...
def element(n, i, j, chi_grid, power_grid, redshift_grid):
    ...
    condition2 = (n == i) & (n + 1 == j) & (n + 1 < grid_size)
    condition3 = (n == i) & (n + 1 < j) & (j < grid_size) & (n + 1 < grid_size)
    condition4 = (n + 1 == i) & (n + 1 < j) & (j < grid_size) & (n + 1 < grid_size)
    condition5 = (n + 1 == i) & (n == j) & (n + 2 < chi_grid.shape[0])
    condition6 = (n + 1 == i) & (n + 1 == j) & (n + 2 < chi_grid.shape[0])
    condition7 = (i == grid_size) & (n == j) & (n < grid_size)
    condition8 = (i == grid_size) & (n + 1 == j) & (n + 1 < grid_size)
